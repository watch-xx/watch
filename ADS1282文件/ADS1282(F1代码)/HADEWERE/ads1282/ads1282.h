...
//引脚
#define DRDY  PAin(4)
#define RESET PAout(5)
#define SYNC  PAout(6)


void ADS1282_Init(void);  //
void ADS1282_WriyeCommond(u8 data);       //写命令
void ADS1282_WriteBytes(u16 com,u8 data);//写一个字节
u8 ADS1282_ReadBytes(u16 com);            //读一个字节
u32 ADS1282_ReadData(void);               //读取转换值
u32 ADS1282_ReadDataContinu(void);            //连续读
